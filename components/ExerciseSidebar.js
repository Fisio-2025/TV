        ...
        this.innerHTML = `
            <div class="bg-[#F8FAFC] rounded-xl flex flex-col p-6 shadow-lg h-full">
                <div class="mb-8">
                    ...
                    <h1 class="text-2xl font-extrabold text-slate-800 mb-4" id="ui-title">Daily Routine</h1>
                ...
                <div class="mb-8">
                    <div class="flex items-center gap-3 mb-4">
                        <h2 class="text-xl font-extrabold text-slate-800" id="ui-current-exercise">Push-ups</h2>
                ...
                <div class="flex-1 overflow-y-auto mb-6 flex flex-col gap-1 pr-2" id="ui-exercise-list">
                    ${exercises.map(e => `
                        <exercise-item 
                            number="${e.number}" 
                            name="${e.name}" 
